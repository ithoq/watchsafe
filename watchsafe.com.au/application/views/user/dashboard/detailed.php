...
<input type='hidden' name='mileage' value='<?=$HeaderResult['mileage']?>'></input>    
   <table style="margin: 20px 0;">
    ...
    <td style="padding: 0 20px;">
        <a href="/user/dashboard?imei=<?=$HeaderResult['imei']?>&name=<?=$HeaderResult['name']?>&points=<?=$HeaderResult['points']?>&trips=<?=$HeaderResult['trips']?>&mileage=<?=$HeaderResult['mileage']?>&show_all=true" class="btn btn-info btn-small">Show all datas</a>
    </td>
    <td style="padding: 0 20px;">
       <a href="/user/dashboard?imei=<?=$HeaderResult['imei']?>&name=<?=$HeaderResult['name']?>&points=<?=$HeaderResult['points']?>&trips=<?=$HeaderResult['trips']?>&mileage=<?=$HeaderResult['mileage']?>" class="btn btn-info btn-small">Clear all filters</a>
    </td>
    <td >
   ...
   ?>
            ...
            <tr>			      
             ...
             <td><?=isset($row['alerts']) ? $row['alerts']: 'Driving'?></td>
			   	   ...
			   	   <!--<td><a href="#" class="btn btn-info">Maps</a></td>-->
...
No trips  
<?php }?>
<a href="/user/dashboard" class="btn btn-info btn-small">Back</a>
...
<?php if (count($AlertResult)>0) {?>
   ...
   ?>
            ...
            <tr>
             ...
             <?php if (isset($ModalData[$row['ID']])) { ?>
             <td><a href="#myModal<?=$row['ID']?>" role="button" class="btn btn-info" data-toggle="modal">More</a></td>
             <?php } ?>
      </tr>     
